(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('ngx-bootstrap/collapse'), require('hammerjs'), require('ngx-file-uploader'), require('@angular/platform-browser'), require('@angular/material/datepicker'), require('@angular/material/form-field'), require('@angular/material'), require('@angular/material/core'), require('@angular/material-moment-adapter'), require('amazing-time-picker'), require('@angular/material/select'), require('rxjs'), require('moment'), require('lodash'), require('@angular/http'), require('@angular/common'), require('@angular/core'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('ngx-openmrs-formentry', ['exports', 'ngx-bootstrap/collapse', 'hammerjs', 'ngx-file-uploader', '@angular/platform-browser', '@angular/material/datepicker', '@angular/material/form-field', '@angular/material', '@angular/material/core', '@angular/material-moment-adapter', 'amazing-time-picker', '@angular/material/select', 'rxjs', 'moment', 'lodash', '@angular/http', '@angular/common', '@angular/core', '@angular/forms'], factory) :
    (factory((global['ngx-openmrs-formentry'] = {}),global.collapse,null,global.ngxFileUploader,global.ng.platformBrowser,global.ng.material.datepicker,global.ng.material['form-field'],global.ng.material,global.ng.material.core,global.ng['material-moment-adapter'],global.amazingTimePicker,global.ng.material.select,global.rxjs,global.moment_,global._,global.ng.http,global.ng.common,global.ng.core,global.ng.forms));
}(this, (function (exports,collapse,hammerjs,ngxFileUploader,platformBrowser,datepicker,formField,material,core,materialMomentAdapter,amazingTimePicker,select,rxjs,moment_,_,http,common,core$1,forms) { 'use strict';
    ...
    var NgxDateTimePickerComponent = /** @class */ (function () {
         ...
         */
            function ($event) {
                ...
                /** @type {?} */
                var nextWeekDate = moment$3(dateToUse).add($event, 'weeks');
                /** @type {?} */
